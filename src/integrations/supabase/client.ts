...
const projectUrl = SUPABASE_URL?.trim() || "https://rrxsevbgtprbtfakidqe.supabase.co";
const projectKey = SUPABASE_PUBLISHABLE_KEY?.trim() || "sb_publishable_e5udXFWl7w_gMFH_ezq-pg_Fx8KvzWd";
